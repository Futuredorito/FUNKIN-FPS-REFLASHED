...
class ChartEditor extends MusicBeatState
{
	...
	**/
	...
	function addSongUI():Void
	{
		...
		diffDrop.selectedLabel = PlayState.storyDifficulty;

		var removeNotes:FlxButton = new FlxButton(saveButton.x + saveButton.width + 20, saveButton.y + 10, "Remove Notes", function()
		{
			_song.notes = [];
		});
		...
		//tab_group_song.add(removeNotes); will be used later on
