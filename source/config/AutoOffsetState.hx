...
class AutoOffsetState extends MusicBeatState
{
	...
	function exit():Void {
		...
		ending = true;
		Config.write(offsetCalc, Config.uiType, Config.healthMultiplier, Config.healthDrainMultiplier, Config.comboType, Config.downscroll, Config.noteGlow, Config.ghostTapType, Config.noFpsCap, Config.controllerScheme, Config.bgDim, Config.noteSplashType, Config.debug, Config.oppHitType);
